...
(function(factory) {
        ...
        if (!H.ColorAxis) {
            ...
            extend(ColorAxis.prototype, {
                ...
                defaultColorAxisOptions: {
                     ...
                     * ends at this value.
                     * 
                     * If dataClasses are set, the color is based on minnTick: true,
                     ...
                     * ends at this value.
                     * 
                     * If dataClasses are set, the color is based on min    // Base init() pushes it to the xAxis array, now pop it again
    ...
    (function(H) {
        ...
        seriesType('heatmap', 'scatter', {
            ...
            tooltip: {
                pointFormat: '{poi colorAxis.toColor(value, point) :
                            point.color || series.color
                        );
