...
(function(factory) {
            ...
            beforeSetTickPositions: function() {
                ...
                if (isOrdinal || hasBreaks) { // #4167 YAxis is never ordinal ?
                    ...
                    if (useOrdinal) {
                        ...
                        // and Math.min to prevent padding on either sides of th var ordinalSlope = axis.ordinalSlope,
    ...
    (function(H) {
         ...
         * 
         * <pre>{
         *     millisecond: ['%A, %b %e, %H:%Mighcharts));
    (function() {
   ...
   return is undefined
         ...
         */
        wrap(Tooltip.prototype, 'tooltipFooterHeaderFormatter', function(p      );
            }
    ...
    (function(H) {
        ...
        Scrollbar.prototype = {
            ...
            setRange: function(from, to) {
                ...
                if (newSize < minWidth) {
                    fromPX = (fullWidth - minWidth + newSize) *          translateX: x,
                    translateY: scroller.y
                });
            ...
            cursorToScrollbarPosition: function(normalizedEvent) {
                ...
                return {
                    ...
                    chartY: (normalizedEvent.chartY - scroller.y - scroller.yOffset) / (scroller.barWr.enabled) {
                // Predefined options:
    ...
    (function(H) {
        ...
        Navigator.prototype = {
            ...
            renderElements: function() {
                ...
                navigator.navigatorGroup = navigatorGroup = renderer.g('navigatone;
            ...
            render: function(min, max, pxMin, pxMax) {
                ...
                if (currentRange < minRange) {
                     ...
                     */
                    if (this.grabbedLeft) {
                        pxMin = er = mouseUpHandler = function(e) {
            ...
            modifyNavigatorAxisExtremes: function() {
                ...
                if (xAxis.getExtremes) {
                    ...
                    if (
                        ...
                        xAxis.min = unionExtremes.dataMin;
                        xAxis.max = unionExtremes.dataMax;
          avigator series data to the new data of the base series
            ...
            each(axes2, function(A) {
                if (defined(A.options.id) ? A.options.id.indexOf('navigator') === -1 : true) {
                    var a = (A.isXAxis ? 'yAxis' : 'xAxis'),
                        rax = (defined(A.options[a]) ? chart[a][A.options[a]] :is.crossLabel) {
