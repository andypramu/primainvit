            ...
            beforeSetTickPositions: function() {
                ...
                if (isOrdinal || hasBreaks) { // #4167 YAxis is never ordinal ?
                    ...
                    if (useOrdinal) {
                        ...
                        // and Math.min to prevent padding on either sides of thfunction it is sorted as strings
                            });
                    ...
                    if (plotY !== undefined && plotX >= 0 && !outsideRight) {
                        ...
                        if (!graphic) {
                            graphic = point.graphic = renderer.label(
                                    ...
                                    null,
                                    shape,
                   tends plotOptions.series.tooltip
             * @excluding changeDecimals,valueDecimals,valuePrefix,valueSuffix
             * @product highstock
             */
            tooltip: {
        ...
        extend(defaultOptions, {
            ...
            rangeSelector: {
                ...
                buttonTheme: {
                    ...
                    width: 28,
                    height: 18,
                    paddingall(this, newOptions, false);
            if (this.chart.navigator && !this.options.isInternal) {
                this.chart.navigator.setBaseSeries(null, false);
            }
            if (pick(redraw, true)) {
...
putGroup.offset += dateBox.width + (isMin ? 10 : 0);
    ...
    (function(H) {
        ...
        H.StockChart = H.stockChart = function(a, b, c) {
            ...
            options = merge({
                    ...
                    scrollbar: {
                        // #4988 - check if y built Chart object should always run in the
         *         callback. Defining a {@link https://api.highcharts.com/highstock/chart.events.load|
         *         chart.event.load} handler is equivalent.
         *
         * @return {Chart}
                ...
                if (value !== undefined && compareValue !== undefined) { // #2601, #5814
                    ...
                    if (compare === 'value') {
                        ...
                        value = 100 * (value / compareValue) -
                            (this.options.coat ? ':' + formatFormat : '') + '}';
            }
