        ...
        if (!H.ColorAxis) {
            ...
            extend(ColorAxis.prototype, {
                ...
                defaultColorAxisOptions: {
                     ...
                     * 
                     * @type {Color}
                     * @sample {highmaps} maps/coloraxis/mincolor-maxcolor/ Min and max colors onnTick: true,
                     ...
                     * 
                     * @type {Color}
                     * @sample {highmaps} maps/coloraxis/mincolor-maxcolor/ Min and max colors on         this.initStops();
