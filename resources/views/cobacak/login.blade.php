...
<div class="login-box">
  <div class="login-logo">
    <a href="adminlte2/index2.html"><b>Prima</b>INVIT</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="adminlte2/index2" method="post">
    ...
    <a href="/primainvit/public/register" class="text-center">Register a new membership</a>
